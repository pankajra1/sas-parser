...
then
    ...
    transformsGradleDistributionUrl="${ORG_GRADLE_PROJECT_artifactsUri}/repositories/ri.gradle.distributions.artifacts.repository/contents/release/files/gradle-7.5.1-bin.zip"
fi
